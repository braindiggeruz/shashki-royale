...
import { RotateCcw, User, Trophy, Crown } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-sm flex items-center justify-between">
        <div className="flex gap-2">
          ...
          >
            ...
            <span className="text-xs" style={{ color: "#D4AF37", fontFamily: "Cinzel, serif" }}>
      ...
      >
              ...
              >
                <div className="flex items-center justify-between mb-3">
                  <div>
                    ...
                    {activeGame.roomCode && (
                      <p className="text-sm mt-0.5" style={{ color: "rgba(212,175,55,0.4)" }}>
                        Код: <span style={{ color: "#FFD700", letterSpacing: "0.15em" }}>{activeGame.roomCode}</span>
                        {" · "}
                  ...
                  <button
                    onClick={() => { clearActiveGame(); setActiveGame(null); }}
                ...
                {resumeError && (
                  <p className="text-xs text-center mt-2" style={{ color: "#ff9999" }}>
                    {resumeError}
                  </p>
                )}
              </div>
        ...
        {supabaseConfigured && (
          <PrimaryButton onClick={() => navigate("/stake-lobby")} variant="ghost">
            🏆 Турниры
          </PrimaryButton>
        )}
